...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(kaolin-galaxy
                         zenburn
                         spacemacs-dark
                         gruvbox)
